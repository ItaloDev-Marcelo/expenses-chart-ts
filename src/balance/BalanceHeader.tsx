...
const BalanceHeader = () => {
  return (
    <header className='bg-Primary-red flex justify-between items-center 
    h-[90px] rounded-2xl w-[325px] md:w-[375px] xl:w-[400px] p-2 mt-2 mb-4 xl:mt-10 ds:mt-30 ds:scale-125 ds:mb-20'>
